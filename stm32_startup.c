...
uint32_t vector_table[] __attribute__((section(".isr_sector"))) = {
STACK_START,
...
void Reset_Handler(void)
{
    ...
    uint32_t size = (uint32_t) &_edata - (uint32_t) &_sdata; // '&' is used to get the symbol value (the adrress in this case)
